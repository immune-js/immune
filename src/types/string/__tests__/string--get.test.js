...
test("it should return the value unwrapped when non-null value exists at the specified index and a default is provided", () => {
  expect(get("abc", 0, 10)).toBe("a")
})

test("it should return the default value when the index is out of range and a default is provided", () => {
