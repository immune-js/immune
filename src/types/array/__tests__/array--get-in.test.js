...
test("it should return the original collection wrapped in a Some when given an empty path", () => {
...
test("it should return a None if no value exists at the specified path", () => {
