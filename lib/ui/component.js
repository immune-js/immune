...
export var AsyncComponent = Type("AsyncComponent", { component: Task,
  path: Array,
  props: Object
});
...
export var component = function component(comp) {
...
component.async = function (task, path) {
  var props = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return AsyncComponent(task, Array.isArray(path) ? path : [path], props);
};
