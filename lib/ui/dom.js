...
export default function app(props) {
  ...
  return function render(view) {
    flush(element = patch(root, element, node, node = view, skipRender = !skipRender));
  };
  ...
  function initActions(state, actions, source) {
    ...
    function update(data) {
      return typeof data === "function" ? update(data(state)) : data && repaint(assign(state, data)), globalState;
    }
  }
