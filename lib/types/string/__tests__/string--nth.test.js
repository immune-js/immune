...
test("it should return the value unwrapped when non-null value exists at the specified index and a default value is provided", function () {
  expect(nth("abc", 0, "x")).toBe("a");
});

test("it should return the default value when the index is out of range and a default was provided", function () {
