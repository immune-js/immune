import { match, show } from "../../..";

test("it should return a Some with a list of matches if one or more matches was found", function () {
...
test("it should return None if no match was found", function () {
